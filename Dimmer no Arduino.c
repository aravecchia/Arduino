...
int controle = 13;       // Pino ligado ao circuito do Triac
...
// por exemplo, troque 8 (no comando map) por period e rode o arquivo no proteus.
// veja entao a saida no osciloscopio. 
