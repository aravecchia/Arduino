...
{
  int t=50;
  //so um delay que eu preciso rever onde fica e quantos milisegundos dura.
...

  {
    ...
    else if ((tempbase <= (10*temperatura)) && ((10*temperatura) < (tempbase+10)) && (digitalRead(agua) == LOW) && (tempbase!=0))
    {
      digitalWrite(vent1, HIGH); 
    ...
    else if ((tempbase <= (10*temperatura)) && ((10*temperatura) < (tempbase+1)) && (digitalRead(agua) == HIGH) && (tempbase!=0))
    {
      digitalWrite(vent1, HIGH); 
      digitalWrite(vent2, HIGH); 
      digitalWrite(bomba, HIGH);
