...
#include <Wire.h>
LiquidCrystal lcd(8, 9, 4, 5, 6, 7);   //Use estes valores quando trabalhar na protoboard
//LiquidCrystal lcd(13, 12, 11, 10, 9, 8);   //Use estes valores quando trabalhar no proteus
const int entrada = 2;
